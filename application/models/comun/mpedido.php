...
class MPedido extends CI_Model {
  ...
  function cabeceraJSON() {
    ...
    $cabecera[2] = array("titulo" => "Nombre Usuario", "atributos" => "width:350px");
    $cabecera[3] = array("titulo" => "telefono", "atributos" => "width:350px");
    $cabecera[4] = array("titulo" => "Correo", "atributos" => "width:350px");
    $cabecera[5] = array("titulo" => "Total", "atributos" => "width:100px");
    $cabecera[6] = array("titulo" => "Orden", "atributos" => "width:100px");
    $cabecera[7] = array("titulo" => "Ultima Fecha", "atributos" => "width:100px");
    return $cabecera;
  }
  ...
  function cabezeraJSONCliente() {
    ...
    $cabecera[4] = array("titulo" => "Banco", "atributos" => "width:100px","tipo"=>"texto_fijo");
    $cabecera[5] = array("titulo" => "Deposito", "atributos" => "width:120px","tipo"=>"texto_fijo");
    $cabecera[6] = array("titulo" => "Observaciones", "tipo"=>"texto_fijo");
    $cabecera[7] = array("titulo" => "Fecha", "tipo"=>"calendario");
    $cabecera[8] = array("titulo" => "oidu", "oculto"=>1);
    $cabecera[9] = array("titulo" => "A", "tipo" => "bimagen", "funcion" => 'Aceptar_Deposito', "parametro" => "2,4,5,6,7,8", "ruta" => __IMG__ . "botones/aceptar1.png", "atributos" => "width:10px");
    $cabecera[10] = array("titulo" => "R", "tipo" => "bimagen", "funcion" => 'Rechazar_Pedido_Cliente', "parametro" => "2,8", "ruta" => __IMG__ . "botones/quitar.png", "atributos" => "width:10px");
  ...
  function cabezeraJSONAdmin() {
  	...
  	$cabecera[6] = array("titulo" => "Banco", "atributos" => "width:100px","tipo"=>"texto_fijo");
  	$cabecera[7] = array("titulo" => "Deposito", "atributos" => "width:120px","tipo"=>"texto_fijo");
  	$cabecera[8] = array("titulo" => "Observaciones", "tipo"=>"texto_fijo");
  	$cabecera[9] = array("titulo" => "Fecha", "tipo"=>"calendario");
  	$cabecera[10] = array("titulo" => "oidu", "oculto"=>1);
  	$cabecera[11] = array("titulo" => "A", "tipo" => "bimagen", "funcion" => 'Aceptar_Deposito', "parametro" => "4,6,7,8,9,10", "ruta" => __IMG__ . "botones/aceptar1.png", "atributos" => "width:10px");
  	$cabecera[12] = array("titulo" => "R", "tipo" => "bimagen", "funcion" => 'Rechazar_Pedido_Cliente', "parametro" => "4,10", "ruta" => __IMG__ . "botones/quitar.png", "atributos" => "width:10px");
   ...
   * @param string $tipo 0: Pendiente, 1: Procesando, 2: Procesado, 3: Cancelado Por Cliente 4: Cancelado por administrador
